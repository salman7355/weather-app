...
const Weather = ({ weather }) => {
  ...
  return (
    <div className="relative flex flex-col justify-between max-w-[500px] w-full h-[86vh] m-auto p-4 text-gray-300 z-10">
      ...
      <div className="bg-black/50 relative text-gray-200 mb-10 p-8  rounded-xl">
